 ...
 */
- (void)contextualKClass:(id<KslackKotlinKClass>)kClass provider:(id<KslackKotlinx_serialization_coreKSerializer> (^)(NSArray<id<KslackKotlinx_serialization_coreKSerializer>> *))provider __attribute__((swift_name("contextual(kClass:provider:)")));
 ...
 */
- (void)polymorphicDefaultSerializerBaseClass:(id<KslackKotlinKClass>)baseClass defaultSerializerProvider:(id<KslackKotlinx_serialization_coreSerializationStrategy> _Nullable (^)(id))defaultSerializerProvider __attribute__((swift_name("polymorphicDefaultSerializer(baseClass:defaultSerializerProvider:)")));
@end
